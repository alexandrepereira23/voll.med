...
4. **Vulnerabilidades npm resolvidas.** A correcao foi aplicada com seguranca via `npm audit fix` (sem uso de `--force`), resultando em 0 vulnerabilidades no `npm audit`, com testes, typecheck e build do frontend validados.
